...
public class IntAmpelGUI
{
    ...
    private Button _roteLinksLampe;
    private Button _grueneLinksLampe;
    ...
    private void initialisiereLampen(TilePane root)
    {
        ...
        _roteRechtsLampe = neueLampe(5);
        root.getChildren().add(_roteRechtsLampe);
        _grueneRechtsLampe = neueLampe(6);
        root.getChildren().add(_grueneRechtsLampe);
    }
    ...
    private void aktualisiereLampen()
    {
        ...
        _roteLinksLampe.setTextFill(_ampel.leuchtetRot()? Color.RED : Color.BLACK);
        _grueneLinksLampe.setTextFill(_ampel.leuchtetGruen() ? Color.LIME : Color.BLACK);
    }
}
