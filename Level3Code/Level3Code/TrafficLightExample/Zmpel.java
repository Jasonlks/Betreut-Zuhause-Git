...
class Zmpel
{
    ...
    {
        // Die grüne Lampe wird in der nächsten Phase genau dann leuchten,
        ...
        // Wovon hängt es ab, ob die rote Lampe in der nächsten Phase leuchten wird?
        _rot = _rot^_gelb;
    ...
    public boolean lampenTest (Zmpel ampel) {
            if (ampel instanceof Zmpel) {
                return true;
            }
            return false;
    }
